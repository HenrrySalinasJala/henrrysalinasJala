...
import GetStartedPage from '../pages/get_started.page'
import SelfRegistrationModal from '../pages/self_registration.modal.page'
...
export default class HomePageActions {
  ...
  async enrollTraveler(companyEmail) {
    ...
    await actions.click(profileDropDown).click(optionElement)
    ...
    await actions.click(countryDropDown).click(countryElement)
